# Reflected XSS in Inventory System (View Payments)
...
* **Version**: 1.0
* **Component**: View Payments (`view_payments.php`)
* **Vulnerable Parameter**: `limit` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `view_payments.php` file.
...
```
http://127.0.0.1:8089/view_payments.php?limit=%22%3E%3CscrIpt%3Ealert(15623);%3C/scRipt%3E
...
<img width="925" height="669" alt="图片" src="https://github.com/user-attachments/assets/40c9cf94-22e9-493f-a451-15b84f1e6d06" />
