# Reflected XSS in Inventory System (View Sales)
...
* **Version**: 1.0
* **Component**: View Sales (`view_sales.php`)
* **Vulnerable Parameter**: `limit` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `view_sales.php` file.
...
```
http://127.0.0.1:8089/view_sales.php?limit=%22%3E%3Cscript%3Ealert(15623);%3C/script%3E
...
<img width="1183" height="759" alt="图片" src="https://github.com/user-attachments/assets/ab2f680f-c8a7-4a6a-af78-005a1244ab48" />
